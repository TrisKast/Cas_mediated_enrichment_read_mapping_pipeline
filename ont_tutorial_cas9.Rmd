...
* The list of on-target read Ids can be found in the file **` `r file.path("Analysis","OnTarget",paste0(study,".OnTarget.mappedreads"))` `**
* The **`fastq`** sequence file containing the raw sequence reads corresponding to these Ids can be found in the file **` `r file.path("Analysis","OnTarget",paste0(study,".OnTarget.fastq"))` `**
...
* The list of off-target read Ids can be found in the file **` `r file.path("Analysis","OffTarget",paste0(study,".OffTarget.mappedreads"))``**
* The **`fastq`** sequence file containing the raw sequence reads corresponding to these Ids can be found in the file **` `r file.path("Analysis","OffTarget",paste0(study,".OffTarget.fastq"))` `**
